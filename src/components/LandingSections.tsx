...
export default function LandingSections() {
  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#F5F1E4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 rounded-xl border border-[#D9D3FB] bg-[#F9F8FF] shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-[#8870FF] mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="pt-4">
                <button
                  ...
                  disabled={isLoading}
                  className="inline-flex items-center justify-center px-6 py-3 bg-[#8870FF] text-white font-semibold rounded-xl shadow-lg hover:bg-[#6a54e0] hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#8870FF] focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12">
            ...
            <div className="text-center space-y-4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#D9D3FB] text-[#8870FF] font-bold text-2xl mb-4">
                1
              </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#FAF9F6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-xl border-2 border-[#D9D3FB] bg-[#F9F8FF]">
            ...
            {/* Leavs Column */}
            <div className="p-8 rounded-xl border-2 border-[#8870FF] bg-[#D9D3FB]/30">
              <h3 className="text-xl font-semibold text-slate-900 mb-6 text-center">
                Leavs
              </h3>
              <ul className="space-y-4">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#F5F1E4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="p-6 rounded-xl border border-[#D9D3FB] bg-[#F9F8FF] text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#D9D3FB] rounded-full flex items-center justify-center">
                <svg className="w-8 h-8 text-[#8870FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Section 6 - Final CTA */}
      <section className="py-16 sm:py-20 lg:py-24 bg-[#1E1152]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
            Stop guessing. Start planning.
          </h2>
          <p className="text-xl text-[#D9D3FB] mb-8">
            Free for students.
          </p>
          ...
          <div className="flex flex-col items-center">
            <button
              onClick={handleGetStarted}
              disabled={isLoading}
              className="inline-flex items-center justify-center px-8 py-4 bg-[#FF5402] text-white font-semibold rounded-xl shadow-xl hover:bg-[#e64a00] hover:shadow-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#FF5402] focus:ring-offset-2 focus:ring-offset-[#1E1152] disabled:opacity-60 disabled:cursor-not-allowed text-lg"
            >
              {isLoading ? 'Loading...' : 'Create My Relocation Plan'}
            </button>
            <p className="text-sm text-[#D9D3FB]/60 mt-4">
              Takes ~3 minutes.
            </p>
          </div>
        </div>
