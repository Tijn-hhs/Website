              ...
              <div className="mt-5">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { name: 'Equal Opportunities Office (DSA)', detail: "Supports students with disabilities, chronic conditions, or learning differences (dyslexia, dyscalculia, etc.), including exam accommodations and more." },
